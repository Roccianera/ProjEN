    ...
    const fetchProject = async () => {
      try {
        ...
        const mockData: ProjectRequestDto = {
          ...
          description: "Questo è un progetto di esempio che mostra come strutturare i dati secondo lo schema fornito",
          endDate: "2025-06-30",
          taskCategories: [
            {
              ...
              tasks: [
                {
                  name: "Design UI/UX",
                  description: "Creare wireframe e mockup dell'interfaccia utente",
                  endDate: "2025-04-15"
                },
                {
                  name: "Implementazione componenti React",
                  description: "Sviluppare componenti riutilizzabili basati su Material UI",
                  endDate: "2025-05-01"
                }
              ]
            },
            {
              ...
              tasks: [
                ...
                },
                {
                  ...
                  description: "Configurare il database e creare le tabelle necessarie",
                  endDate: "2025-04-20"
                },
                {
                  name: "Autenticazione e autorizzazione",
                  description: "Implementare il sistema di sicurezza e gestione utenti",
                  endDate: "2025-05-15"
                }
              ]
            }
        ...
        setError("Si è verificato un errore durante il recupero dei dati del progetto");
        setLoading(false);
      }
    };
      ...
      >
        <Container>
          ...
          >
            ...
            <Typography variant="h5" mt={3} mb={2} display="flex" alignItems="center">
